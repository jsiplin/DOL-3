...
let wdaFooter = `
<div class="Footer">
  <p id= "wda_footer">Notes:<br>"TBD" represents values that are yet to be determined.<br>For Industry Metrics, "0" values in Educational Services means value suppressed because it does not meet U.S. Census Bureau publication standards.<br>Data source: Longitudinal Employer-Household Dynamics (LEHD), last accessed on October 1, 2022<br></p>
</div>
`
